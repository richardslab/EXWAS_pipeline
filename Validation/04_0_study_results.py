...
alphamiss_gwas_files = {"ZBMD":"step_2_ZBMD_ExWAS_pLOF_missense_ZBMD.regenie",
...
for pheno,file in alphamiss_gwas_files.items():
  Alphamissense_res = pd.read_csv(
    ...
    Models = lambda df: df['TEST'].map(test_map)
