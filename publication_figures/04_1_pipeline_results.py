...
with open("./parameters/script_params.yml",'r') as ptr:
  params = yaml.safe_load(ptr)['study_results_1']
outdir = params['outdir']

#%% pipeline backman results
pipeline_backman_path = params['pipeline_backman_path']
...
pipeline_alpha_continuous_path=params['pipeline_alpha_continuous_path']
...
pipeline_alpha_binary_path=params['pipeline_alpha_binary_path']
