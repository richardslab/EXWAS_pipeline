"""
  Compare the effect sizes of workflow results with Backman et al 2021
"""
#%%
...
with open("./parameters/script_params.yml",'r') as ptr:
  params = yaml.safe_load(ptr)['backman_etal2021_01']
...
ffile_pp_plof = os.path.join(params['outdir'],'pval_pval_regeneron_plof.png')
ffile_pp_plof_5in5 = os.path.join(params['outdir'],'pval_pval_regeneron_plof_or_5in5.png')
...
# own regenie results:
pipeline_result_path=params['pipeline_result_path']
