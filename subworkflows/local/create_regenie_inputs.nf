...
workflow CREATE_REGENIE_INPUT {
  ...
  emit:
    setlist = setlist_res.setlist_files
    setlist_logs = setlist_res.log

    annotation = annotate_file_res.regenie_annotations
    annotate_log = annotate_file_res.log

    mask = mask_res.mask_files
    mask_log = mask_res.log
}
